...
//		Thread.sleep(2000);
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@ id='paymentmethod_3']")));
		driver.findElement(By.xpath("//input[@ id='paymentmethod_3']")).click();
		//Thread.sleep(5000);
		//
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@ name='PurchaseOrderNumber']")));
		driver.findElement(By.xpath("//input[@ name='PurchaseOrderNumber']")).sendKeys("123456789");
