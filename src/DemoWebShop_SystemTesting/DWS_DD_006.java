...
public class DWS_DD_006 {
	public static void main(String[] args) throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("(//div/a/img[1])[2]"))));
		driver.findElement(By.xpath("(//div/a/img[1])[2]")).click();
		//Thread.sleep(2000);
		
		//Click on add to cart 
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//input[@ id='add-to-cart-button-53']"))));
...
//		System.out.println(successMessage);
		...
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//select[@id='billing-address-select']"))));
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@ id='paymentmethod_0']")));
