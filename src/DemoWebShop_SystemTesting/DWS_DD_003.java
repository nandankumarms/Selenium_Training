...
public class DWS_DD_003 {
	public static void main(String[] args) throws InterruptedException {
		...
		//Login
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//a[contains(text(),'Log in')]"))));
		...
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("(//a[contains(text(),'Digital download')])[1]"))));
...
//		System.out.println(successMessage);
		...
		//Click on continue button
				wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//input[@ title='Continue']"))));
...
//		Thread.sleep(2000);
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@name='paymentmethod'])[2]")));
		...
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("(//input[@ value='Continue'])[3]"))));
...
//		Thread.sleep(2000);
		...
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//li[contains(text(),'Order number')]"))));
		...
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//input[@ value='Continue']"))));
